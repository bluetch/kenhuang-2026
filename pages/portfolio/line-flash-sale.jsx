      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-4 text-gray-500">
            ...
            <p>After that, we might start to implement our features. But the most important things is to understand who we are designing for. What kind of problems are we trying to solve? The designer will be faced with tons of challenges. If usability test has a lot of good feedback and product managers want to increase the user's retention rate, conversion rate, rating and daily active user, then the solution will probably want to add some key features to see if the business matrix goes well or not. And some of the features might provide better searching experience such as better searching experience, category and filter feature. Therefore, we've selected some popular features or the most important feature from PC platform into app version.</p>
          </div>
